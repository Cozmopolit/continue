...
| `core` (Vitest)            | vitest     | `cd core; npm run vitest`                     | 105 Files (104 passed, 1 skipped), 0 failed (siehe Timing-Hinweis unten)                                                            |
| `gui`                      | vitest     | `cd gui; npm test`                            | 49 Files / 530 Tests, 0 failed                                                                                                      |
