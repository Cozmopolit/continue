...
**Zahlen-Refresh 2026-08-21 (Registrierung beim Verbindungsaufbau)** (Board-Handle-Registrierung unabhängig vom Watch-Toggle: core-Vitest unverändert 106 Files, `board/boardClient.vitest.ts` +12 Tests (`tryRegisterBoardIdentity` 5, `registerBoardIdentity` 7 — Retry-Semantik 2 s/20 s mit Fake-Timern, Concurrency-Guard, verspätetes Gateway). Gezielter Lauf: 22/22 grün in 7 s.)
